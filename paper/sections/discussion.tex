...
diagnostics document the mismatch between their marginal objective and transfer:
marginal discrepancy falls to $0.010\times$ its unaligned value while the
class-conditional diagnostic falls only to $0.07\times$. The two diagnostics
have different null normalisers, so their ratio is descriptive rather than a
