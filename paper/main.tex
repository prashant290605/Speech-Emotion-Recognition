...
cell, with mean gains of $0.1342$ and $0.1969$ against chance baselines of
$0.1665$ and $0.1656$. Logistic regression provides a finite-solver contrast
and does not generally retain exact numerical equality. We then factor affine
...
\input{sections/selection_theory}
