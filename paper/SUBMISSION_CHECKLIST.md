...
| Final author order, affiliations and corresponding author | **VERIFY** | Prashant Singh, Pranav Singh and Phyo Thet Yee share the IIT Ropar affiliation; the equal-contribution note applies to the two Singh authors only. Prashant Singh is the corresponding author. Phyo Thet Yee supervised the project this work extends and is listed last. Confirm the final legal names and contact details in the portal, and confirm that every co-author has approved the manuscript and agreed to be listed. |
...
| Abstract, keywords, main sections, captions and editable tables | **VERIFY** | The current abstract contains 208 whitespace-delimited words, six keywords are present, and numbered sections and editable tables compile. Confirm the portal word count and final Overleaf output. |
...
| 2026-09-24 | Added Phyo Thet Yee as the third author with the shared IIT Ropar affiliation and institutional email. She supervised the course project this work extends, so she is listed last with the CRediT role Supervision; the equal-contribution footnote was narrowed to name the two Singh authors explicitly, and the running head became `P. Singh et al.`. No ORCID was recorded for her. Rebuilt and visually checked the CAS PDF. |
