\begin{table*}[!t]
  \centering
  \caption{Split sizes and the floors every macro-F1 in this paper is read against. Both directions are matched-$n$: CREMA-D source-train is subsampled from 5972 to match RAVDESS, so a reported asymmetry is not a source-training-size effect alone.}
  \label{tab:floors}
