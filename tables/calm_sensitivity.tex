\begin{table*}[!t]
  ...
  \end{tabular}
  \\[2pt]
  \begin{minipage}{\linewidth}\footnotesize Filter: cached hubert last-layer features, logreg, and none, zscore, mean_shift, coral. The chance baselines are 0.1665 and 0.1645. This robustness control is not a replacement full classifier grid.\end{minipage}
\end{table*}
