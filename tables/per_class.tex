\begin{table}[tb]
  \centering
  \caption{Per-class F1 of the validated configuration, from the stored per-utterance predictions. \texttt{sad} and \texttt{happy} fall below the macro average in both directions.}
  \label{tab:perclass}
  \begin{tabular}{lrrrr}
    \toprule
