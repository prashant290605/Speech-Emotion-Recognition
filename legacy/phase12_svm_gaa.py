...
def main() -> None:
    set_seed()
    log_step("[phase12] Loading datasets")
    ...
    log_step("[phase12] Preparing wav2vec2 features")
    ...
    log_step("[phase12] Preparing MFCC features")
    ...
    log_step("[phase12] Applying CORAL and GAA")
