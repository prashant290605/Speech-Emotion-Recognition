...
def main() -> None:
    log_step("[phase2-forward] Loading datasets")
    ...
    log_step("[phase2-forward] Preparing wav2vec2 features")
    ...
    log_step("[phase2-forward] Preparing MFCC features")
    ...
    log_step("[phase2-forward] Applying CORAL")
    ...
    for alpha in ALPHAS:
        log_step(f"[phase2-forward] Training alpha={alpha:.2f}")
    ...
    save_result(
        "phase2_alpha_sweep_forward.json",
        {
            "phase": "phase2_alpha_sweep_forward",
            "train_dataset": "RAVDESS",
            "test_dataset": "CREMA-D",
