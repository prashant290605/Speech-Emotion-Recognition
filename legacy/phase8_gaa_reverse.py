...
def main() -> None:
    set_seed()
    log_step("[phase8] Loading datasets")
    ...
    log_step("[phase8] Preparing wav2vec2 features")
    ...
    log_step("[phase8] Preparing MFCC features")
    ...
    log_step("[phase8] Applying CORAL and group clustering")
