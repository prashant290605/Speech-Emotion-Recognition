...
def main():
    ...
    tex.extend([
        ...
        r"matched \texttt{none}/\texttt{mean\_shift} rows only. "
        r"Generated by \texttt{tools/audit\_translation.py} from the "
        r"configuration \texttt{configs/audit\_translation.yaml}. "
        r"The JSON report retains input/configuration hashes and both run IDs "
        r"for every pair. Means are descriptive, not independent-cell inference."
