...
[RESULTS.md §8–9](reports/RESULTS.md) — five claims made during this rebuild
...
Twelve phases; see [PHASES.md](PHASES.md) for the plan and
...
The manuscript is written from [reports/RESULTS.md](reports/RESULTS.md), with
tables from `tables/*.tex` and figures from `figures/*.pdf`. Pre-revision
sources under [`legacy/`](legacy/) contain the results this rebuild corrects and
should not be cited.
